<?php
session_start(); // Pokreće sesiju za rad s prijavama

// Ako je korisnik već prijavljen, preusmjeri ga na početnu stranicu
if (isset($_SESSION['id'])) { // Promijenite 'user_id' u 'id'
    $username = $_SESSION['korisnicko_ime']; // Ovdje ostavite 'korisnicko_ime' kao naziv za korisničko ime
} else {
    $username = null;
}
?>
